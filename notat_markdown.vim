" Vim syntax file
" Based on the markdown syntax file by Tim Pope <vimNOSPAM@tpope.org>
...
syn match markdownListMarker " \{4\}[-*+]\%(\s\+\S\)\@=" contained
syn match markdownListMarker " \{8\}[-*+]\%(\s\+\S\)\@=" contained
syn match markdownListMarker "\t\{0,4\}[-*+]\%(\s\+\S\)\@=" contained
" syn match markdownOrderedListMarker " \{0,4}\<\d\+\.\%(\s*\S\)\@=" contained
syn match markdownOrderedListMarker " \{4\}\<\d\+\.\%(\s*\S\)\@=" contained
syn match markdownOrderedListMarker " \{8\}\<\d\+\.\%(\s*\S\)\@=" contained
syn match markdownOrderedListMarker "\t\{0,4}\<\d\+\.\%(\s*\S\)\@=" contained
